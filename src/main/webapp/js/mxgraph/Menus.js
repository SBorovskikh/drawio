 ...
 * Sets the default font size.
 */
Menus.prototype.defaultMenuItems = ['file', 'edit', 'view', 'arrange', 'extras', 'help', 'blockschema'];
...
Menus.prototype.init = function()
{
	...
	console.log("@debug - add block schema main item")
	this.put('blockschema', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		console.log("@debug - load blockschema menu items")
		this.addMenuItems(menu, ['bs_loadschema']);
	})));
};
